...
(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const parentLogger = pino_1.default();
        parentLogger.info(`Parent logger instance created`);
        const offeringsService = new offerings_service_1.OfferingsService(pool, parentLogger);
        const trainingRequestService = new training_request_service_1.TrainingRequestService(pool, parentLogger);
